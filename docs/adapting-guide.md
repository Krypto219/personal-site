...
1. You've finished modifying >95% of the pages. Search through the rest of the files for references to `Dejan` or `Kojadinovic` and change values to your name.
